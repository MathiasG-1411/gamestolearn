      ...
      belts: [
        {
          ...
          textColor: "#1F2937",
          emoji: "⚪",
          description: "Tables de 2 et de 5 — réponses mêlées (à taper + QCM)",
          questions: [
            { question: "2 × 4 = ?", answer: "8", explanation: "2 × 4 = 8. On double 4." },
            { question: "2 × 7 = ?", choices: ["12", "16", "14", "18"], correctIndex: 2, explanation: "2 × 7 = 14 (on compte 2 par 2)." },
            { question: "2 × 9 = ?", answer: "18", explanation: "2 × 9 = 18." },
            { question: "5 × 3 = ?", answer: "15", explanation: "5 × 3 = 15. La table de 5 finit par 0 ou 5." },
            { question: "5 × 6 = ?", choices: ["25", "20", "35", "30"], correctIndex: 3, explanation: "5 × 6 = 30." },
            { question: "5 × 8 = ?", answer: "40", explanation: "5 × 8 = 40." },
            { question: "2 × 6 = ?", answer: "12", explanation: "2 × 6 = 12." },
            { question: "5 × 5 = ?", choices: ["20", "25", "30", "15"], correctIndex: 1, explanation: "5 × 5 = 25." },
            { question: "2 × 10 = ?", answer: "20", explanation: "2 × 10 = 20." },
            { question: "5 × 9 = ?", answer: "45", explanation: "5 × 9 = 45." },
          ],
        },
        {
          id: "jaune",
          ...
          color: "#FACC15",
          emoji: "🟡",
          description: "Tables de 4 et de 10 — réponse à taper",
          questions: [
            { question: "4 × 3 = ?", answer: "12", explanation: "4 × 3 = 12." },
            { question: "4 × 5 = ?", answer: "20", explanation: "4 × 5 = 20." },
            { question: "4 × 7 = ?", answer: "28", explanation: "4 × 7 = 28." },
            { question: "4 × 8 = ?", answer: "32", explanation: "4 × 8 = 32." },
            { question: "10 × 4 = ?", answer: "40", explanation: "10 × 4 = 40. On ajoute un zéro." },
            { question: "10 × 7 = ?", answer: "70", explanation: "10 × 7 = 70." },
            { question: "10 × 9 = ?", answer: "90", explanation: "10 × 9 = 90." },
            { question: "4 × 6 = ?", answer: "24", explanation: "4 × 6 = 24." },
            { question: "4 × 9 = ?", answer: "36", explanation: "4 × 9 = 36." },
            { question: "10 × 6 = ?", answer: "60", explanation: "10 × 6 = 60." },
          ],
        },
        {
          id: "orange",
          ...
          color: "#FB923C",
          emoji: "🟠",
          description: "Tables de 3 et de 6 — à taper, avec chrono",
          timePerQuestion: 20,
          questions: [
            { question: "3 × 4 = ?", answer: "12", explanation: "3 × 4 = 12." },
            { question: "3 × 7 = ?", answer: "21", explanation: "3 × 7 = 21." },
            { question: "3 × 9 = ?", answer: "27", explanation: "3 × 9 = 27." },
            { question: "3 × 8 = ?", answer: "24", explanation: "3 × 8 = 24." },
            { question: "6 × 3 = ?", answer: "18", explanation: "6 × 3 = 18." },
            { question: "6 × 5 = ?", answer: "30", explanation: "6 × 5 = 30." },
            { question: "6 × 7 = ?", answer: "42", explanation: "6 × 7 = 42." },
            { question: "6 × 8 = ?", answer: "48", explanation: "6 × 8 = 48." },
            { question: "3 × 6 = ?", answer: "18", explanation: "3 × 6 = 18." },
            { question: "6 × 6 = ?", answer: "36", explanation: "6 × 6 = 36." },
          ],
        },
        {
          id: "verte",
          ...
          color: "#22C55E",
          emoji: "🟢",
          description: "Tables de 7 et de 8 — à taper, les plus coriaces",
          timePerQuestion: 18,
          questions: [
            { question: "7 × 3 = ?", answer: "21", explanation: "7 × 3 = 21." },
            { question: "7 × 6 = ?", answer: "42", explanation: "7 × 6 = 42." },
            { question: "7 × 8 = ?", answer: "56", explanation: "7 × 8 = 56." },
            { question: "7 × 9 = ?", answer: "63", explanation: "7 × 9 = 63. Astuce : 70 − 7 = 63." },
            { question: "8 × 4 = ?", answer: "32", explanation: "8 × 4 = 32." },
            { question: "8 × 6 = ?", answer: "48", explanation: "8 × 6 = 48." },
            { question: "8 × 7 = ?", answer: "56", explanation: "8 × 7 = 56 (comme 7 × 8)." },
            { question: "8 × 8 = ?", answer: "64", explanation: "8 × 8 = 64." },
            { question: "7 × 7 = ?", answer: "49", explanation: "7 × 7 = 49." },
            { question: "8 × 9 = ?", answer: "72", explanation: "8 × 9 = 72. Astuce : 80 − 8 = 72." },
          ],
        },
        {
          id: "bleue",
          ...
          color: "#3B82F6",
          emoji: "🔵",
          description: "Table de 9 et tables mélangées — à taper",
          timePerQuestion: 15,
          questions: [
            { question: "9 × 2 = ?", answer: "18", explanation: "9 × 2 = 18." },
            { question: "9 × 4 = ?", answer: "36", explanation: "9 × 4 = 36. Astuce : 40 − 4 = 36." },
            { question: "9 × 6 = ?", answer: "54", explanation: "9 × 6 = 54." },
            { question: "9 × 7 = ?", answer: "63", explanation: "9 × 7 = 63." },
            { question: "9 × 8 = ?", answer: "72", explanation: "9 × 8 = 72." },
            { question: "9 × 9 = ?", answer: "81", explanation: "9 × 9 = 81." },
            { question: "6 × 9 = ?", answer: "54", explanation: "6 × 9 = 54 (comme 9 × 6)." },
            { question: "9 × 5 = ?", answer: "45", explanation: "9 × 5 = 45." },
            { question: "9 × 3 = ?", answer: "27", explanation: "9 × 3 = 27." },
            { question: "9 × 10 = ?", answer: "90", explanation: "9 × 10 = 90." },
          ],
        },
        {
          id: "marron",
          ...
          color: "#92400E",
          emoji: "🟤",
          description: "Divisions — à taper, l'opération inverse",
          timePerQuestion: 15,
          questions: [
            { question: "12 ÷ 2 = ?", answer: "6", explanation: "12 ÷ 2 = 6 car 2 × 6 = 12." },
            { question: "20 ÷ 5 = ?", answer: "4", explanation: "20 ÷ 5 = 4 car 5 × 4 = 20." },
            { question: "24 ÷ 4 = ?", answer: "6", explanation: "24 ÷ 4 = 6 car 4 × 6 = 24." },
            { question: "36 ÷ 6 = ?", answer: "6", explanation: "36 ÷ 6 = 6 car 6 × 6 = 36." },
            { question: "56 ÷ 7 = ?", answer: "8", explanation: "56 ÷ 7 = 8 car 7 × 8 = 56." },
            { question: "64 ÷ 8 = ?", answer: "8", explanation: "64 ÷ 8 = 8 car 8 × 8 = 64." },
            { question: "81 ÷ 9 = ?", answer: "9", explanation: "81 ÷ 9 = 9 car 9 × 9 = 81." },
            { question: "30 ÷ 5 = ?", answer: "6", explanation: "30 ÷ 5 = 6 car 5 × 6 = 30." },
            { question: "42 ÷ 6 = ?", answer: "7", explanation: "42 ÷ 6 = 7 car 6 × 7 = 42." },
            { question: "72 ÷ 8 = ?", answer: "9", explanation: "72 ÷ 8 = 9 car 8 × 9 = 72." },
          ],
        },
        {
          id: "noire",
          ...
          color: "#1F2937",
          emoji: "⚫",
          description: "Tout mélangé : ×, ÷, facteur manquant et problèmes — à taper",
          timePerQuestion: 12,
          questions: [
            { question: "7 × 8 = ?", answer: "56", explanation: "7 × 8 = 56." },
            { question: "63 ÷ 9 = ?", answer: "7", explanation: "63 ÷ 9 = 7 car 9 × 7 = 63." },
            { question: "6 × ? = 48 (tape le nombre manquant)", answer: "8", explanation: "6 × 8 = 48 → on calcule 48 ÷ 6 = 8." },
            { question: "? × 7 = 49 (tape le nombre manquant)", answer: "7", explanation: "7 × 7 = 49 → le facteur manquant est 7." },
            { question: "8 × 9 = ?", answer: "72", explanation: "8 × 9 = 72." },
            { question: "54 ÷ 6 = ?", answer: "9", explanation: "54 ÷ 6 = 9 car 6 × 9 = 54." },
            { question: "9 × 7 = ?", answer: "63", explanation: "9 × 7 = 63." },
            { question: "7 paquets de 8 gommes, combien de gommes ?", answer: "56", placeholder: "Nombre de gommes", explanation: "7 × 8 = 56 gommes. Des paquets égaux → multiplication." },
            { question: "56 billes partagées en 8 sachets égaux, combien par sachet ?", answer: "7", placeholder: "Billes par sachet", explanation: "56 ÷ 8 = 7 billes par sachet. Partage équitable → division." },
            { question: "9 × ? = 81 (tape le nombre manquant)", answer: "9", explanation: "9 × 9 = 81 → le facteur manquant est 9." },
          ],
        },
      ],
    },
